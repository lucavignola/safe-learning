...
def train(
    ...
    elif load_buffer and params[-1] is None:
        logging.warning("Requested to load buffer but could not find data")
    ...
    def sgd_step(
        ...
        # A conditional path could reduce overhead here in the future.
